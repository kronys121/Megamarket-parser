...
for name_id in content_id:
    try:
        ...
        comments_rate = name_id.find("div", class_= "catalog-item-review").find("a", class_="catalog-item-review__link")
        ...
        print(f"Name: {name} Price: {price} Rate: {comments_rate} {comments_rate_count}")
